...
,(Select CMS_Content From CMS_WebsiteContent Where CMSID = PICMS_AccommodationCMSID) as CMSHotel
    ...
    //         Order by PCCID desc";
        ...
        public static string SQL_Vacations_Places_Hierarchy_Priority(string PlaceTitle, bool IsInList = false, bool includePriority = false)
        {
            return @"SELECT STR_UserID,STRID,STR_PlaceID,STR_PlaceTitle,STR_PlaceTypeID,isNull(STR_PageTemplate,'T1') as STR_PageTemplate, STR_PlacePriority, STR_PlaceExtra, STR_PlaceMap, STR_PlaceShortInfo, STR_PlaceTitleDesc, STR_PlacePractical, STR_PlaceSpa
                FROM STR_Places_Hierarchy
                WHERE STR_PlaceActive = 1" +
                (includePriority ? " AND STR_PlacePriority = 1" : string.Empty) +
