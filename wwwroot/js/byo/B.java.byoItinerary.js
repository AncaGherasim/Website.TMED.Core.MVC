...
$(document).ready(function () {
    ...
    $('input:text[id*="xdropoffCityTxt"]').change(function () {
        var o = 1;
        //console.log("dfsdfsdfsd"); carSelected($(this).id)
    });
});
...
function doitDeparture(ctyNa) {
    ...
    $('#' + ctyNa + '').autocomplete({
        ...
        (ctyNa == 'xtxtLeavingFrom') ? ($('#xtxtLeavingFrom').removeClass('errorClass'), $('#xIDLeavingFrom').val('-1')) : ''
    ...
    if (impTxt.indexOf('Place') > 0) { useData = carTake; carAutoComplete(impTxt, useData); }
        ...
        for (i = 0; i <= dropData.length - 1; i++) {
            ...
            if (datLn[0] == "E" || datLn[0] == "S") {
                ...
                useData.push({ label: datLn[1] + '. ' + datLn[0], value: datLn[1] + '. ' + datLn[0], id: datLn[1] });
            };
...
function setUpDownMove() {
    $('.iconUp').click(function () {
        ...
        $(inpDn).animate({ 'opacity': '0', 'margin-top': '30px' }, 300); 
