...
$(document).ready(function () {
	...
	switch (userid) {
		case 243:
			SiteName = "https://www.tripmasters.com/europe/";
			break;
		//case 595:
		//	SiteName = "https://www.tripmasters.com/europe/";
		//	break;
	//	case 182:
	//		SiteName = "https://www.tripmasters.com/latin/";
	//		break;
	}
	...
	$('.moreButton').click(function () {
		$('.dvEachHide').is(':visible') === false ?
			($(this).html('Close More Highlights & Attractions <span>&rsaquo;</span>'), $('.dvEachHide').slideDown(), $('div.moreButton span').css('transform', 'rotate(270deg)', 'padding-right', 'unset'))
	...
	$('.dvotherInfo').each(function () {
	    ...
	    idNum == objid ? (
	        $('#' + idDiv + '').is(':visible') == false ? (
	            $('#' + idDiv + '').slideDown(),
	            $('p[id=' + idNum + ']').find('span').css({'transform':'rotate(-135deg)','margin':'7px 10px'}),
	            ...
	            $('div.dveachOtherMore[lang="' + idNum + '"]').find('span').css('transform', 'rotate(270deg)')
	                ...
	                $('p[id=' + idNum + ']').find('span').css({'transform': 'rotate(45deg)', 'margin': '4px 10px'}),
		...
		success: function (data) {
			...
			if (msg !== '') {
				...
				for (i = 0; i <= strPrts.length - 1; i++) {
					...
					relTxt = relTxt + '<span style="float:left; margin-right:5px; margin-bottom:15px;">'
					...
					if (echP[2] != 5) {
						mrChoice = mrChoice + '<span style="float:left; margin-right:5px; margin-bottom:15px;"><a style="cursor:pointer;" class="falsecheckdop" id="falsedop' + echP[3] + '" >' + echP[0] + '</a>'
