...
function gotoURL(tourl,w,h){
	...
	//if(newURL.charAt(0) == '/'){ newURL = seoDir + newURL.substring(1,newURL.length)}
...
function CMSmoreInfo(id,iW,iH){
	...
	if (siteAB.toLowerCase().indexOf('tvlapi') > -1){
		...
		switch (bpDom){
			...
			break;
			//case 'beachdestinations.bookingprocess.com':
			//	domainCMS = 'http://beachdestinations.com';
			//break;
